...
class Analizador{
    ...
    public static func inicia(aviones: [Avion]){
        Analizador.memoria[0] = aviones
    }
    ...
    public static func coalicion(numPaso: Int, aviones: [Avion]) -> Int{
        var numCoaliciones = 0
        var prueba = true
        
        return numCoaliciones;
    }
}
